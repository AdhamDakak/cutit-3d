  ...
  return (
    <SafeAreaView className="flex-1 bg-[#f7f5f1] dark:bg-zinc-950" edges={['top', 'bottom']}>
      <View className="flex-row items-center justify-between border-b border-stone-200 bg-white px-5 py-4 dark:border-zinc-800 dark:bg-zinc-900">
        ...
        <Text className="flex-1 text-center font-serif text-lg font-semibold text-stone-900 dark:text-white">Help</Text>
      ...
      <View className="gap-3 px-5 py-6">
        ...
        >
          <Text className="text-xs font-semibold text-white">Reschedule Booking</Text>
        </Pressable>
        ...
        >
          <Text className="text-xs font-semibold text-stone-700 dark:text-zinc-200">Cancel Booking</Text>
        </Pressable>
